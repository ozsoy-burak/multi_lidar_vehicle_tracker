...
class MovingBoxController:
    def __init__(self):
        ...
        self.model_name = rospy.get_param("~model_name", "ambulance")


        self.start_x = rospy.get_param("~start_x", 28.4)
        self.start_y = rospy.get_param("~start_y", -26.72)
        ...
        self.state.pose.orientation.z = math.sin(-1.57)
        self.state.pose.orientation.w = math.cos(-1.57)
